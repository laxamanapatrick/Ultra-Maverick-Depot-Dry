...
export const Header = (props) => {
  const { sideBarHandler, unsetRequest, moveOrderIdOnApp, userFullname } =
    props;
    ...
    >
      ...
      <HStack>
        <Box p={2} borderRight="1px" borderColor="primary" cursor="pointer">
          <Menu>
            <MenuButton>
              <Flex _hover={{ color: "accent" }} alignItems="center">
                <Text color="white" mr="1">
                  <FaUserCircle color="#87CEAA" size="24px" cursor="pointer" />
                </Text>
              </Flex>
            </MenuButton>
            <MenuList>
              ...
              <MenuItem _hover={{ color: "accent" }} onClick={logout}>
                Log out
              </MenuItem>
            </MenuList>
          </Menu>
