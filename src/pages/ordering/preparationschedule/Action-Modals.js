...
export const ScheduleConfirmation = ({
  ...
  const minDate = moment(dateToday).format("yyyy-MM-DD");
  const maxDate = moment(
    new Date(dateToday.setMonth(dateToday.getMonth() + 6))
  ).format("yyyy-MM-DD");
        ...
        <ModalBody>
          <VStack textAlign="start">
            <HStack spacing={4} w="full" justifyContent="center">
              ...
              <Text w="97%" pl={2} py={2} bgColor="gray.200" border="1px">
                {farmName && farmName}
              </Text>
            </HStack>
            <HStack spacing={4} w="full" justifyContent="center">
              ...
              <Input
                ...
                type="date"
                bgColor="#fff8dc"
                onChange={(e) => dateProvider(e.target.value)}
                min={minDate}
                max={maxDate}
              />
            </HStack>
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Text mt={5} textAlign="center">
            Are you sure you want to schedule these ({checkedItems?.length})
            orders?
          </Text>
        </ModalBody>
