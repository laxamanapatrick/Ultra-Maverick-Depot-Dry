...
import { Badge, Box, Button, Checkbox, Flex, HStack, Input, Select, Table, Tbody, Td, Text, Th, Thead, Tr, useDisclosure, VStack } from '@chakra-ui/react'
import {
    Pagination,
    usePagination,
    PaginationNext,
...
export const ListofOrders = ({ setCurrentPage, currentPage, pagesCount,
    ...
    const filteredCategories = [...new Set(orderCategories?.map(item => item.category))]
