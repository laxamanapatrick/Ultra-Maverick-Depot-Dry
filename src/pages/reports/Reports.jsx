...
import { ConsolidatedReport } from "./reportsdropdown/Consolidated-Report";
            ...
            <Flex justifyContent="start" flexDirection="column">
              ...
              <HStack>
                ...
                >
                  ...
                  <option value={9}>Consolidated Report</option>
                  <option value={10}>Inventory Movement</option>
                  <option value={11}>Nearly Expiry Report</option>
                </Select>
                <Button
              ...
              {sample < 11 ? (
                <Flex justifyContent="start" flexDirection="row">
                  ...
                  <Flex flexDirection="column" ml={1}>
                    <Flex>
                      <Badge>
                        {sample === 10 ? "Rollback Date" : "Date to"}
                      </Badge>
                    </Flex>
                    <Input
                      bgColor="#fff8dc"
                      ...
                      min={
                        sample === 9
                          ? minimumDateForInventoryMovement
                          : undefined
                      }
                    />
                  </Flex>
