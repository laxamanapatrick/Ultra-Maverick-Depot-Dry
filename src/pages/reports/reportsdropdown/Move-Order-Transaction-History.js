...
const fetchMoveOrderHistoryApi = async (dateFrom, dateTo) => {
  const res = await apiClient.get(
    `Report/MoveOrderHistory?dateFrom=${dateFrom}&dateTo=${dateTo}`
  );
  return res.data;
};
      ...
      setSheetData(
        res?.map((item, i) => {
          return {
            ...
            "Weighted Average Unit Cost": item.weightedAverageUnitCost,
              ...
              <Tr>
                ...
                {buttonChanger ? (
                  <>
                    ...
                    <Th color="white">Weighted Average Unit Cost</Th>
                ...
                <Tr key={i}>
                  ...
                  {buttonChanger ? (
                    <>
                      ...
                      <Td>{item.category}</Td>
                      <Td>{item.quantity}</Td>
                      <Td>{item.weightedAverageUnitCost}</Td>
                      {/* <Td>{item.batchNo}</Td> */}
                    </>
                  ) : (
                    <>
