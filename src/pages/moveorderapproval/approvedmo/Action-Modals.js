                  ...
                  <Table size="xs" fontSize="xs">
                    ...
                    <Tbody>
                      {printData?.map((item, i) => {
                        if ((i + 1) % 9 === 0 && i !== 0) {
                          // Add a new page before rendering the next set of rows
                          return (
                            <>
                              <Tr borderBottom="1px" key={i}>
                                {/* Render the next set of rows */}
                                <Td>{item.itemCode}</Td>
                                <Td>{item.itemDescription}</Td>
                                <Td>{item.uom}</Td>
                                <Td>{item.quantity}</Td>
