  ...
  const { register } = useForm({
    ...
    defaultValues: {
      displayData: {
        ...
        actualDelivered: itemCodeData.actualDelivered.toLocaleString(
          undefined,
        ...
        expectedDelivery: itemCodeData.expectedDelivery.toLocaleString(
          undefined,
          { maximumFractionDigits: 2, minimumFractionDigits: 2 }
        ),
        updatedStock: (
          parseInt(itemCodeData.totalStock) +
          parseInt(itemCodeData.actualDelivered)
        ).toLocaleString(undefined, {
          maximumFractionDigits: 2,
          minimumFractionDigits: 2,
        }),
        actualReject: sumQuantity.toLocaleString(undefined, {
          maximumFractionDigits: 2,
          minimumFractionDigits: 2,
        }),
      },
        ...
        <Stack spacing={5}>
              ...
              {lotCategories.length > 0 ? (
                ...
                >
                  {lotCategories?.map((lot) => (
                    <option key={lot.id} value={lot.categoryName}>
                      {lot.categoryName}
                    </option>
                  ))}
                </Select>
          ...
          <Flex justifyContent="space-between">
            ...
            <FormLabel w="40%">
              Actual Good
              <Input
                value={actualGood.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                  minimumFractionDigits: 2,
                })}
                readOnly={true}
