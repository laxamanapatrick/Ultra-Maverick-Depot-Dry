      ...
      <VStack w="full" spacing={6}>
        ...
        <Flex w="95%" justifyContent="space-between">
          ...
          <VStack alignItems="start" w="40%" mx={5}>
            ...
            <HStack w="full">
              ...
              <Text w="full" border="1px" borderColor="gray.200" py={1.5}>
        ...
        <Flex w="full" justifyContent="end" mt={4}>
          <Button
            onClick={() => openModal()}
            disabled={
              !rawMatsInfo.customer || !details || !remarks || !transactionDate
            }
            size="xs"
            colorScheme="blue"
          >
...
export const RawMatsInfoModal = ({
  ...
  const itemCodeHandler = (data) => {
    if (data) {
      ...
      setIsExpirable(newData?.isExpirable);
      setRawMatsInfo({
        itemCode: itemCode,
