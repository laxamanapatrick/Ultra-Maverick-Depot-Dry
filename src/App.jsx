      ...
      <Routes>
        ...
        <Route path="/" element={user ? <Layout sideBarHandler={SideBarHandler} isSidebarVisible={isSidebarVisible} notification={notification} fetchNotification={fetchNotification} /> : <Navigate to="/login" />} >
          ...
          <Route path="inventory" element={user ? <InventoryPage notification={notification} fetchNotification={fetchNotification} /> : <Navigate to="/login" />}>
            ...
            <Route path="move-order" element={user ? <MoveOrderPage notification={notification} fetchNotification={fetchNotification} unsetRequest={unsetRequest} /> : <Navigate to="/login" />} />
          ...
          <Route path="ordering" element={user ? <OrderingPage notification={notification} fetchNotification={fetchNotification} /> : <Navigate to="/login" />}>
            <Route path="orders" element={user ? <ImportOrderPage notification={notification} fetchNotification={fetchNotification} /> : <Navigate to="/login" />} />
          ...
          {
            currentUser?.role === 1 &&
            <Route path="sandbox" element={user ? <Sandbox /> : <Navigate to="/login" />} />
          }
